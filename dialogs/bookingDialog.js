...
class BookingDialog extends CancelAndHelpDialog {
    ...
    async originStep(stepContext) {
        ...
        if (!bookingDetails.origin) {
            const messageText = 'ggFrom what city will you be travelling?';
            const msg = MessageFactory.text(messageText, 'ggFrom what city will you be travelling?', InputHints.ExpectingInput);
            return await stepContext.prompt(TEXT_PROMPT, { prompt: msg });
        }
